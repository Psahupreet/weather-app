...
const API_KEY = "edccb48b485a6660e22f119c1427d3c2"; // API key for OpenWeatherMap API
    ...
    .then((data) => {
      if (!data.length) {
        document.querySelector(
          ".error"
        ).textContent = `"PLEASE enter correct city name!" ${cityName}`;
